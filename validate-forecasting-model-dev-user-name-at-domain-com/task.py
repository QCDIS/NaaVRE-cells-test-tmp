...
arg_parser.add_argument('--scenario_data_all_file', action='store', type=str, required=True, dest='scenario_data_all_file')
...
scenario_data_all_file = args.scenario_data_all_file.replace('"','')
...
import json
filename = "/tmp/validation_all_zScores_file_" + id + ".json"
file_validation_all_zScores_file = open(filename, "w")
file_validation_all_zScores_file.write(json.dumps(validation_all_zScores_file))
file_validation_all_zScores_file.close()
